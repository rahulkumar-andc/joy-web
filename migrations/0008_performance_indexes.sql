...
CREATE INDEX IF NOT EXISTS idx_products_homepage_flags 
...
CREATE INDEX IF NOT EXISTS idx_hero_campaigns_is_active 
ON hero_campaigns(is_active, priority DESC);

-- Index for time-based campaign selection
CREATE INDEX IF NOT EXISTS idx_hero_campaigns_time_window 
